...
error_reporting(0);
  ...
  if(isset($_POST['submit'])){
   ...
   // print_r($_POST);
  if($pass==$cpass){
  $select_query = mysqli_query($conn,"SELECT email from provider where email='$email' ");
  $num_email = mysqli_num_rows($select_query);
  
  
  if($num_email==0){
      $insert_query = mysqli_query($conn, "INSERT INTO provider(pro_name,pro_desc,pro_phone,pro_email,pro_pass) VALUES('$name','$desc','$phone','$email','$pass')");
        ...
        <div class="wrapper">
            <div class="container">
                ...
                <form class="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    ...
                    <input type="password" placeholder="Mobile" name="phone" required>
