<?php 
  ...
  if(isset($_POST['submit'])){
    extract($_POST);
    $pro_id = $_SESSION['pro']['pro_id'];
  $insert_service = mysqli_query($conn,"INSERT INTO service(s_name,s_desc,s_place,s_price,pro_id) VALUES('$name','$details','$location','$price','$pro_id')");
  }
